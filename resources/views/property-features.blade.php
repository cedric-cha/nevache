    ...
    <div>
        <div class="row mb-3 text-end">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <input type="text" placeholder="Entrez le titre de l'annonce" class="form-control" name="titre" id="titre">
            </div>
        </div>
        ...
        <div class="row mb-3 inline text-end">
            ...
            <div class="col-8">
                <div class="table-responsive-lg" style="height: 300px;">
                    <!-- Salle de bain -->
                    <table class="table table-bordered">
                        <div class="text-start"><b>Salle de bain</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" id="seche-cheveux" value="seche-cheveux">
                                    <label for="">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="produit" id="produit">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="shampoing" id="shampoing">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="douche-exterieure" id="douche-exterieure">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="eau-chaude" id="eau-chaude">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="gel-douche" id="gel-douche">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <!-- Chambre et linge -->
                    <table class="table table-bordered">
                        <div class="text-start"><b>Chambre et linge</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="lave-linge" id="lave-linge">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="equipements-base" id="equipements-base">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="cintres" id="cintres">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="draps" id="draps">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="store" id="store">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="fer-a-repasser" id="fer-a-repasser">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="etendoir-a-linge" id="etendoir-a-linge">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                                            <path d="M16 2a5 5 0 0 1 1.661 9.717 1.002 1.002 0 0 0-.653.816l-.008.126v.813l13.23 9.052a3 3 0 0 1 1.299 2.279l.006.197a3 3 0 0 1-3 3H3.465a3 3 0 0 1-1.694-5.476L15 13.472v-.813c0-1.211.724-2.285 1.816-2.757l.176-.07a3 3 0 1 0-3.987-3.008L13 7h-2a5 5 0 0 1 5-5zm0 13.211L2.9 24.175A1 1 0 0 0 3.465 26h25.07a1 1 0 0 0 .565-1.825z">
                                            </path>
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="coffre-fort" id="coffre-fort">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="armoire" id="armoire">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <!-- Divertissement -->
                    <table class="table table-bordered">
                        <div class="text-start"><b>Divertissement</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="tv" id="tv">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="sonos" id="sonos">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <table class="table table-bordered">
                        <div class="text-start"><b>Chauffage et climatisation</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="cheminee" id="cheminee">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="chauffage" id="chauffage">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="climatisation" id="climatisation">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="ventilateur" id="ventilateur">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <table class="table table-bordered">
                        <div class="text-start"><b>Sécurité à la maison</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="detecteur-de-fumee" id="detecteur-de-fumee">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="extincteur" id="extincteur">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="kit-secours" id="kit-secours">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <!-- Internet et bureau -->
                    <table class="table table-bordered">
                        <div class="text-start"><b>Internet et bureau</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="wifi" id="wifi">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="espace-travail" id="espace-travail">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <table class="table table-bordered">
                        <div class="text-start"><b>Cuisine et salle à manger</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="cuisine" id="cuisine">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="refrigerateur" id="refrigerateur">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                                            <path d="M25 1a2 2 0 0 1 1.995 1.85L27 3v26a2 2 0 0 1-1.85 1.995L25 31H7a2 2 0 0 1-1.995-1.85L5 29V3a2 2 0 0 1 1.85-1.995L7 1zm0 10H7v18h18zm-15 2a1 1 0 1 1 0 2 1 1 0 0 1 0-2zM25 3H7v6h18zM10 5a1 1 0 1 1 0 2 1 1 0 0 1 0-2z">
                                            </path>
                                        </svg>
                                        Réfrigérateur
                                    </label>
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="four-micro-onde" id="four-micro-onde">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="equipement-cuisine" id="equipement-cuisine">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="vaisselle-couverts" id="vaisselle-couverts">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                                            <path d="M29 1v2c-7.18 0-13 5.82-13 13 0 7.077 5.655 12.833 12.693 12.996L29 29v2c-8.284 0-15-6.716-15-15 0-8.18 6.547-14.83 14.686-14.997zM3 1h2v6h2V1h2v6h2V1h2v9a5.002 5.002 0 0 1-3.999 4.9L9 31H7V14.9a5.01 5.01 0 0 1-3.978-4.444l-.017-.232L3 10zm26 6v2a7 7 0 0 0-.24 13.996L29 23v2a9 9 0 0 1-.265-17.996zM10.999 9h-6v.975l.005.176a3 3 0 0 0 5.99.025L11 10z">
                                            </path>
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="mini-refrigerateur" id="mini-refrigerateur">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="cuisiniere-induction" id="cuisiniere-induction">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="bouilloire-electrique" id="bouilloire-electrique">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="grille-pain" id="grille-pain">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="vers_a_vin" id="vers_a_vin">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="ustensile-barbecue" id="ustensile-barbecue">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="table-a-manger" id="table-a-manger">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="four" id="four">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="cafetiere" id="cafetiere">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <!-- Extérieur -->
                    <table class="table table-bordered">
                        <div class="text-start"><b>Extérieur</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="patio-balcon" id="patio-balcon">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                                            <path d="M23 1a2 2 0 0 1 1.995 1.85L25 3v16h4v2h-2v8h2v2H3v-2h2v-8H3v-2h4V3a2 2 0 0 1 1.85-1.995L9 1zM9 21H7v8h2zm4 0h-2v8h2zm4 0h-2v8h2zm4 0h-2v8h2zm4 0h-2v8h2zm-10-8H9v6h6zm8 0h-6v6h6zM15 3H9v8h6zm8 0h-6v8h6z">
                                            </path>
                                        </svg>
                                        Patio ou balcon
                                    </label>
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="arriere-cour" id="arriere-cour">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="mobilier-exterieur" id="mobilier-exterieur">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="repas-plein-air" id="repas-plein-air">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                                            <path d="M29 15v16h-2v-6h-6v6h-2v-6l.005-.15a2 2 0 0 1 1.838-1.844L21 23h6v-8zM5 15v8h6a2 2 0 0 1 1.995 1.85L13 25v6h-2v-6H5v6H3V15zM16 1a15 15 0 0 1 13.556 8.571 1 1 0 0 1-.79 1.423l-.113.006H17v8h8v2h-8v10h-2V21H7v-2h8v-8H3.347a1 1 0 0 1-.946-1.323l.043-.106A15 15 0 0 1 16 1zm0 2C11.71 3 7.799 5.097 5.402 8.468l-.197.284L5.042 9h21.915l-.162-.248a12.995 12.995 0 0 0-10.1-5.734l-.365-.014z">
                                            </path>
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="barbecue" id="barbecue">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                                            <path d="M12.994 2h2c-.002 2.062-.471 3.344-1.765 5.424l-.753 1.183c-.867 1.391-1.278 2.301-1.418 3.393H9.043c.1-1.069.378-1.966.903-3H6c0 5.523 4.477 10 10 10 5.43 0 9.848-4.327 9.996-9.72L26 9l-3.765.001c-.704 1.177-1.05 2.014-1.177 2.999h-2.015c.15-1.613.708-2.836 1.91-4.728l.563-.88c1.116-1.791 1.477-2.784 1.478-4.393h2c-.002 1.919-.408 3.162-1.506 5L28 7v2c0 .682-.057 1.35-.166 2H30v2h-2.683a12.039 12.039 0 0 1-5.896 6.709l4.49 9.877-1.821.828-2.006-4.415H17V30h-2v-4H9.916L7.91 30.413l-1.82-.828 4.49-9.877A12.039 12.039 0 0 1 4.682 13H2v-2h2.166a12.058 12.058 0 0 1-.162-1.695L4 9V7h7.127l.389-.609c1.116-1.79 1.477-2.783 1.478-4.392zm-.56 18.461L10.824 24H15v-3.04a11.95 11.95 0 0 1-2.566-.498zM17 20.96v3.04h4.175l-1.609-3.538c-.684.213-1.395.366-2.126.453zm.994-18.96h2c-.002 2.063-.471 3.345-1.765 5.425l-.753 1.183c-.867 1.391-1.278 2.301-1.418 3.393h-2.015c.15-1.613.708-2.836 1.91-4.728l.563-.88c1.116-1.791 1.477-2.784 1.478-4.393z">
                                            </path>
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="produits-plage" id="produits-plage">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="kayak" id="kayak">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <table class="table table-bordered">
                        <div class="text-start"><b>Parking et installations</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="ascenseur" id="ascenseur">
                                    <label>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="parking-gratuit" id="parking-gratuit">
                                    <label>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="piscine" id="piscine">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="jacuzzi" id="jacuzzi">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="salon-privé" id="salon-privé">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <!-- Services -->
                    <table class="table table-bordered">
                        <div class="text-start"><b>Services</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="arrivee-autonome" id="arrivee-autonome">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="boite-cle" id="boite-cle">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                                            <path d="M25 2a5 5 0 0 1 4.995 4.783L30 7v18a5 5 0 0 1-4.783 4.995L25 30H7a5 5 0 0 1-4.995-4.783L2 25V7a5 5 0 0 1 4.783-4.995L7 2zm0 2H7a3 3 0 0 0-2.995 2.824L4 7v4l2-.001V6h20v20H6v-5.001L4 21v4a3 3 0 0 0 2.824 2.995L7 28h18a3 3 0 0 0 2.995-2.824L28 25V7a3 3 0 0 0-2.824-2.995zm-1 4H8v16h16zm-8 3a5 5 0 1 1 0 10 5 5 0 0 1 0-10zm0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm-10-.001L4 13v6l2-.001z">
                                            </path>
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="longue-duree" id="longue-duree">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="camera" id="camera">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                        ...
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="petit-dej" id="petit-dej">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <table class="table table-bordered">
                        <div class="text-start"><b>Caractéristiques de l'emplacement</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="entree-privee" id="entree-privee">
                                    <label>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: inline; height: 24px; width: 24px; fill: currentcolor;">
                    ...
                    <!-- ........ -->
                    <table class="table table-bordered">
                        <div class="text-start"><b>...</b></div>
                        <tr style="justify-content:center;">
                            <td style="text-align:left;">
                                <div class="custom-control">
                                    <input class="form-check-input" type="checkbox" name="tag[]" value="detecteur-monoxyde" id="detecteur-monoxyde">
                                    <label>
