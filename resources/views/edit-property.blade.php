...
@section('content')
    <div class="container">
        ...
        <div class="d-flex align-items-start" style="margin-top:3.5em;">
            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="btn btn-secondary" href="{{ url('/admin') }}" role="button">Retour</a>
            </div>
            <div class="tab-content border-start offset-md-1" id="v-pills-tabContent">
                        ...
                        <div>
                            <div class="row mb-3 text-end">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                    <input type="text" placeholder="Entrez le titre de l'annonce" class="form-control" name="titre" id="titre" value="{{ $property->titre }}">
                                </div>
                            </div>
                            <div class="row mb-3 inline text-end">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8" style="justify-content:center;"> 
                                    <input type="file" class="form-control" name="image" id="image" accept="image/png, image/jpeg" value="{{asset('storage/img/'.$property->image)}}">
                            ...
                            <div class="row mb-3 inline text-end">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                    <input type="text" class="form-control" placeholder="Entrez la description" name="description" id="description" value="{{ $property->description }}">
                                </div>
                            </div>
                            <div class="row mb-3 inline text-end">
